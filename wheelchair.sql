...
(
    ...
    `oID`         INT          NOT NULL,                -- 订单 ID
    `type`        VARCHAR(20)  NOT NULL,                -- 维修/保养类型
    `pickupDate`  DATE         NOT NULL,                -- 取件日期
    `address`     VARCHAR(255) NOT NULL,                -- 取件地址
    `phone`       VARCHAR(20)  NOT NULL,                -- 联系电话
    `orderStatus` INT          NOT NULL,                -- 订单状态
    PRIMARY KEY (`id`),                                 -- 主键定义
    KEY `idx_order_id` (`oID`)                          -- 为 oID 字段创建索引（可选）
) ENGINE = InnoDB
...
-- ----------------------------
INSERT INTO `t_chair`
VALUES (31, 41, 0, 0, NULL, 'HBLD2-E-1');
INSERT INTO `t_chair`
VALUES (32, 41, 1, 12, NULL, 'HBLD2-E-2');
INSERT INTO `t_chair`
VALUES (33, 41, 0, 0, NULL, 'HBLD2-E-3');
INSERT INTO `t_chair`
VALUES (34, 41, 0, 0, NULL, 'HBLD2-E-4');
INSERT INTO `t_chair`
VALUES (35, 41, 0, 0, NULL, 'HBLD2-E-5');
INSERT INTO `t_chair`
VALUES (36, 41, 0, 0, NULL, 'HBLD2-E-6');
INSERT INTO `t_chair`
VALUES (37, 41, 0, 0, NULL, 'HBLD2-E-7');
INSERT INTO `t_chair`
VALUES (38, 41, 0, 0, NULL, 'HBLD2-E-8');
INSERT INTO `t_chair`
VALUES (39, 41, 0, 0, NULL, 'HBLD2-E-9');
INSERT INTO `t_chair`
VALUES (40, 41, 0, 0, NULL, 'HBLD2-E-10');
...
(
    ...
    `order_status` int                                                           NOT NULL COMMENT '订单状态（0为结束，1为租赁中）',
...
-- ----------------------------
INSERT INTO `t_order`
VALUES (20, 32, 12, '2024-09-16 00:00:00', '2024-09-19 00:00:00', 'ysh', '我家', '12345', 1);
...
-- ----------------------------
INSERT INTO `t_users`
VALUES (3, 'wym', '123456', '13556730677', 'wym');
INSERT INTO `t_users`
VALUES (11, 'lzk', 'lzk', '18320495603', '李先生');
INSERT INTO `t_users`
VALUES (12, 'ysh', '123', '13818882922', 'am');
...
-- ----------------------------
INSERT INTO `t_wheelchair`
VALUES (30, '互邦HBLD2-E电动轮椅可折叠轻便携铝合金锂电池老年人残疾人轮椅代步车', '加宽轮椅，手动折叠', '20', 'HBLD2-E',
        0, 30, '上海', 'http://localhost:8090/images/997b2cc4-fb5c-46da-b8da-82a6ab0de843.jpg', '碧桂园豪庭一期',
        '13813813800', '22',
        'http://localhost:8090/images/b70a0eed-5182-4172-b9f3-d900f066097c.jpg~http://localhost:8090/images/5356fd0b-8ac9-4d39-adb4-c861b5522671.jpg~http://localhost:8090/images/1a6660f5-53b9-4498-aa50-f029af6bfd29.jpg~',
        'wym', '2019-12-12 00:28:43');
INSERT INTO `t_wheelchair`
VALUES (31, '迪护电动轮椅老人全自动越野轻便可折叠旅行便携式家用老年代步电动车专用智能可躺上飞机带坐便器DH-QBK12AQ',
        '小轮便携，手动折叠', '18', 'DH-QBK12AQ', 0, 40, '上海',
        'http://localhost:8090/images/382f528c-59ee-4a4e-bb37-564b88e8489e.jpg', '虎门万达广场', '18818818822', '21',
        'http://localhost:8090/images/92930fad-8fdb-4320-a66e-5189b9c66727.jpg~http://localhost:8090/images/c7f62778-a9b5-4832-b988-452f6ead0d9d.jpg~http://localhost:8090/images/1b33a1f3-a3e5-4f1f-8945-150581a6ee08.jpg~',
        'wym', '2019-12-12 00:32:02');
INSERT INTO `t_wheelchair`
VALUES (32, '贝多适电动轮椅老人全自动越野轻便可折叠旅行便携式家用老年代步电动车专用智能可躺上飞机带坐便器BDS-12AQ',
        '带坐便，小轮便携，加宽轮椅', '20', 'BDS-12AQ', 0, 30, '上海',
        'http://localhost:8090/images/70b4181c-b6c6-46be-9149-78b4a73b494d.jpg', '凯名轩', '16816816800', '30',
        'http://localhost:8090/images/8ce42414-680f-438d-81c5-00b06514ad1d.jpg~http://localhost:8090/images/447f8686-d8f5-48b3-b2c3-09690abe2ae7.jpg~http://localhost:8090/images/bf6d7ced-f44f-4522-8bbb-0502ee921794.jpg~http://localhost:8090/images/d0f7319c-41b1-485f-a0e5-82d3c09ee5ef.jpg~http://localhost:8090/images/830a5fe1-5ece-4a7e-92c6-fab86410b757.jpg~',
        'wym', '2019-12-12 00:36:46');
INSERT INTO `t_wheelchair`
VALUES (41, '互邦HBLD2-E电动轮椅可折叠轻便携铝合金锂电池老年人残疾人轮椅代步车', '加宽轮椅，手动折叠', '20', 'HBLD2-E',
        9, 30, '上海', '', '互邦', '13817355618', '21', '', '管理员', '2024-09-15 16:29:10');
