...
INSERT INTO `t_chair`
VALUES (32, 41, 0, 0, NULL, 'HBLD2-E-2');
INSERT INTO `t_chair`
...
-- ----------------------------
INSERT INTO `t_order`
VALUES (25, 31, 12, '2024-09-20 02:54:27', '2024-09-21 02:54:19', 'test', 'test', '12345678909', 3);
...
(
    ...
    `u_phone_number` varchar(11)  NULL DEFAULT NULL COMMENT '用户注册手机号码，用于找回密码',
    `u_nickname`     varchar(20)  NOT NULL COMMENT '昵称',
    `u_gender`       char(1)      NOT NULL COMMENT '性别，M表示男性，F表示女性',
    `u_birthdate`    date         NOT NULL COMMENT '生日',
    `u_age`          int          NOT NULL COMMENT '年龄',
    PRIMARY KEY (`u_id`),
    UNIQUE INDEX `uniq` (`u_name`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 20
...
VALUES ('wym', '123456', '13556730677', 'wym', 'M', '1990-06-15', 34),
       ('lzk', 'lzk', '18320495603', '李先生', 'M', '1985-03-22', 39),
       ('ysh', '123', '13818882922', 'am', 'F', '1992-11-05', 31),
       ('jdoe', 'password123', '15812345678', 'JohnDoe', 'M', '1991-07-10', 33),
       ('janed', 'pass456', '15987654321', 'JaneD', 'F', '1995-02-18', 29),
       ('mzhang', 'mysecurepwd', '13912347890', '张明', 'M', '1988-12-01', 35),
       ('lili', '789654', '13765478901', '小丽', 'F', '1999-04-25', 25);
...
VALUES (41, '互邦HBLD2-E电动轮椅可折叠轻便携铝合金锂电池老年人残疾人轮椅代步车', '加宽轮椅，手动折叠', '20', 'HBLD2-E',
        10, 30, '上海', '', '互邦', '13817355618', '21', '', '管理员', '2024-09-15 16:29:10');
