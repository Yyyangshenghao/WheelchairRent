...
CREATE TABLE `comment`  (
  ...
  `content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '评论正文',
  `author` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '评论作者',
  `h_id` int NOT NULL COMMENT '轮椅id',
  `createDate` datetime NULL DEFAULT NULL COMMENT '评论时间',
