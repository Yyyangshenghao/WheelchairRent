...
public class Wheelchair {
	...
	public Wheelchair(String wheelchairDesc, String wheelchairModel, String wheelchairArea, String wheelchairFloor, int wheelchairType,
			int wheelchairPrice, String wheelchairAddress, String wheelchairImage, String communityName, String wheelchairLinkMan,
			String wheelchairOriented, String wheelchairDetailsImg, String publisher, Date publishTime) {
		super();
		this.wheelchairDesc = wheelchairDesc;
		this.wheelchairModel = wheelchairModel;
		this.wheelchairArea = wheelchairArea;
	...
	public Wheelchair(int hID, String wheelchairDesc, String wheelchairModel, String wheelchairArea, String wheelchairFloor, int wheelchairType,
			int wheelchairPrice, String wheelchairAddress, String wheelchairImage, String communityName, String wheelchairLinkMan,
			String wheelchairOriented, String wheelchairDetailsImg, String publisher, Date publishTime) {
		super();
		this.hID = hID;
